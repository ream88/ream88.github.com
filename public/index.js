...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CommandLine = __webpack_require__(159);

	var _CommandLine2 = _interopRequireDefault(_CommandLine);

	var _Command = __webpack_require__(165);
	...
	var App = function App() {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "a",
	        { href: "https://twitter.com/ream88", target: "_blank" },
	        "Twitter"
	      ),
	      _react2.default.createElement("br", null),
	      _react2.default.createElement(
	        "a",
	        { href: "https://github.com/haihappen", target: "_blank" },
	        "GitHub"
	      ),
	      _react2.default.createElement("br", null),
	      _react2.default.createElement(
	        "a",
	        { href: "mailto:uher.mario@gmail.com" },
	        "Email"
	      )
	    )
	  );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommandLine = function (_Component) {
	  _inherits(CommandLine, _Component);

	  function CommandLine(props) {
	    _classCallCheck(this, CommandLine);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CommandLine).call(this, props));
	  ...
	  _createClass(CommandLine, [{
	    ...
	    value: function next() {
	      if (this.props.children.length > 0) {
	        this.setState(_extends({}, this.state, {
	          children: [].concat(_toConsumableArray(this.state.children), [this.props.children.shift()])
	        }));
	      } else {
	        this.setState(_extends({}, this.state, {
	          complete: true
	    ...
	    value: function renderPrompt() {
	      return _react2.default.createElement(
	        "span",
	        { className: _index2.default.Prompt, key: "prompt" },
	        this.props.prompt,
	        " "
	      );
	    }
	    ...
	    value: function renderCommands() {
	      ...
	      return this.state.children.map(function (child) {
	        return (0, _react.cloneElement)(child, { key: child.props.command, onComplete: _this2.next.bind(_this2) });
	      });
	    }
	  }, {
	    key: "render",
	    value: function render() {
	      var prompt = this.renderPrompt();
	      var commands = this.renderCommands();

	      // Convert given [command, command] to [prompt, command, br, prompt, command, br, ...]
	      var children = commands.map(function (command, index) {
	        return [(0, _react.cloneElement)(prompt, { key: "prompt-" + index }), command, _react2.default.createElement("br", { key: "br-" + index })];
	      }).reduce(function (a, b) {
	        return a.concat(b);
	      }, []);
	      ...
	      return _react2.default.createElement(
	        "div",
	        { className: _index2.default.CommandLine },
	        children,
	        this.state.complete ? [prompt, _react2.default.createElement(_Cursor2.default, { key: "cursor" })] : null
	      );
	    }
	  }]);
	...
	CommandLine.propTypes = {
	  ...
	  prompt: _react.PropTypes.string.isRequired
	};
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"CommandLine":"index__CommandLine___Vyg-H"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  return _react2.default.createElement("span", { className: _index2.default.Cursor });
	};
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"Cursor":"index__Cursor___2RThZ","blink":"index__blink___86cFb"};
	...
	var Command = function (_Component) {
	  ...
	  _createClass(Command, [{
	    ...
	    value: function tick() {
	      ...
	      this.setState(_extends({}, this.state, { command: this.props.command.slice(0, this.state.command.length + 1) }));

	      if (this.props.command == this.state.command) {
	        setTimeout(function () {
	          _this2.setState(_extends({}, _this2.state, { complete: true }));
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "span",
	        { className: _index2.default.Command },
	        this.state.command,
	        this.state.complete ? [_react2.default.createElement("br", { key: "br" }), this.props.children] : _react2.default.createElement(_Cursor2.default, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"Command":"index__Command___2d0-L"};
